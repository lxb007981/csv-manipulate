...
suite('Extension Test Suite', () => {
    ...
    let originalCsvContent = `resource,col-header1,col-header2,col-header3
row-header1,value1,value2,value3
row-header2,value4,value5,value6`;

    let originalCsvContentSecondRow = `garbage,garbage,garbage,garbage
resource,col-header1,col-header2,col-header3
row-header1,value1,value2,value3
row-header2,value4,value5,value6`;

    let originalCsvContentSecondCol = `garbage,resource,col-header1,col-header2,col-header3
garbage,row-header1,value1,value2,value3
garbage,row-header2,value4,value5,value6`;
    ...
    test('setCellValue', async () => {        const mockEditor: vscode.TextEditor = {            document: mockDocument,            selection: new vscode.Selection(new vscode.Position(0, 0), new vscode.Position(0, 0)),            selections: [],            visibleRanges: [],            options: {},            viewColumn: undefined,            edit: (callback: (editBuilder: vscode.TextEditorEdit) => void): Promise<boolean> => {                const editBuilder: vscode.TextEditorEdit = {                    replace: (location: vscode.Selection, value: string) => {                        const lines = csvContent.split('\n');                        const line = lines[location.start.line];                        const before = line.substring(0, location.start.character);
        ...
        csvContent = `resource,col-header1,col-header2,col-header3\nrow-header1,value1,value2,value3\nrow-header2,value4,value5,value6`;
    ...
    test('setCellValue - second row', async () => {
        ...
        csvContentSecondRow = `garbage,garbage,garbage,garbage\nresource,col-header1,col-header2,col-header3\nrow-header1,value1,value2,value3\nrow-header2,value4,value5,value6`;
        vscode.window.showTextDocument = originalShowTextDocument; // Restore original function
    });
    ...
    test('setCellValue - second col', async () => {
        ...
        await setCellValue(mockEditor, { row: 'row-header1', col: 'col-header2', searchRow: 1, searchCol: 2, target: 'new-value', partialMatch: false });        assert.strictEqual(getCellValue(mockEditor, { row: 'row-header1', col: 'col-header2', searchRow: 1, searchCol: 2, target: '', partialMatch: false }), 'new-value');        csvContentSecondCol = `garbage,resource,col-header1,col-header2,col-header3\ngarbage,row-header1,value1,value2,value3\ngarbage,row-header2,value4,value5,value6`;
        vscode.window.showTextDocument = originalShowTextDocument; // Restore original function
    });
